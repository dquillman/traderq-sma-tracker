# patch-142b.ps1 — Fix yfinance MultiIndex columns in _to_ohlc; bump v1.4.2 (correct Regex usage)
param(
  [switch]$Run,
  [int]$Port = 8602
)
...
# 2) Replace _to_ohlc with robust MultiIndex-safe version (use compiled Regex w/ options)
